...
Reading 1: (Video) \link[The Language of the Universe: Mathematics in Ancient Times]{http://fod.infobase.com.proxy.lib.ohio-state.edu/p_ViewVideo.aspx?xtid=40029}
\begin{itemize}
\item Watch at least Section 1: Emergence of a New Universe
\end{itemize}

Reading 2: \link[Egyptian Mathematics]{http://www.math.tamu.edu/~don.allen/history/egypt/egypt.html}
\begin{itemize}
\item Section 1: Basic Facts About Ancient Egypt
\item Section 2: Counting and Arithmetic: Basics
\end{itemize}

Reading 3: \link[Egyptian Fractions: Ahmes to Fibonacci to Today]{http://www.jstor.org.proxy.lib.ohio-state.edu/stable/27967280}

Reading 4: \link[Chronology for 30000BC to 500BC]{http://www-history.mcs.st-and.ac.uk/Chronology/30000BC_500BC.html}
